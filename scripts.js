    ...
    try {
        ...
        articles.forEach(article => {
            ...
            const articleContent = `
                ...
                <h3>${article.title}</h3>
                <a href="${article.srcUrl}" target="_blank" rel="noopener noreferrer">Read post <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
